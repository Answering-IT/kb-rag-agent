"""
Metadata Utilities for OCR Lambda

Functions to parse S3 paths and generate metadata in the same format
...
def generate_metadata_json(
    ...
    Matches the migration process format:
    {
      "metadataAttributes": {
        "tenant_id": "1",
        "project_id": "949",
    ...
    Note: partition_type is NOT included (removed per requirements)
    """
